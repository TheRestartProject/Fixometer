                ...
                <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="venue" id="venue" class="form-control" placeholder="Neighbourhood or the name of the venue - no 'Restart Party' or 'Repair Cafe'" value="<?php echo $formdata->venue; ?>">
                                </div>
