            <div class="container" id="public-dataviz-stats">
                ...
                <section class="row" id="impact-devices">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class=" col-sm-4 col-md-4"><div class="topper  text-center"><?php echo $top[0]->name . ' [' . $top[0]->counter . ']'; ?></div></div>
                            <div class=" col-sm-4 col-md-4"><div class="topper  text-center"><?php echo $top[1]->name . ' [' . $top[1]->counter . ']'; ?></div></div>
                            <div class=" col-sm-4 col-md-4"><div class="topper  text-center"><?php echo $top[2]->name . ' [' . $top[2]->counter . ']'; ?></div></div>
                        </div>
                    </div>
