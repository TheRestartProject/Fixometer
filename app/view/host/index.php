        ...
        <div role="tabpanel" class="tab-pane" id="details-tab">
            ...
            <div class="row">
                <div class="col-md-2  text-center">
                    <img class="cluster img-responsive" src="/assets/icons/Category_Icons-01.svg">
            ...
            <div class="row">
                <div class="col-md-2  text-center">
                    <img class="cluster img-responsive" src="/assets/icons/Category_Icons-02.svg">
            ...
            <div class="row">
                <div class="col-md-2  text-center">
                    <img class="cluster img-responsive" src="/assets/icons/Category_Icons-03.svg">
            ...
            <div class="row">
                <div class="col-md-2 text-center">
                    <img class="cluster img-responsive" src="/assets/icons/Category_Icons-04.svg">
